...
# 📖 [Awesome-books-ES6-M2] <a name="about-project"></a>

**[Awesome-books-ES6-M2]** is a simple HTML, CSS, and JavaScript project that displays a list of books and allows you to add and remove books from that list.
...
```sh
  cd my-folder
  git clone https://github.com/AlselwiAisha/Awesome-books-ES6-M2.git
```
...
Feel free to check the [issues page](https://github.com/AlselwiAisha/Awesome-books-ES6-M2/issues/).
